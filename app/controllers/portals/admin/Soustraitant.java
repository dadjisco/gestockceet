...
public class Soustraitant extends Controller {

    @Before
    static void setActionMenu() {
        renderArgs.put("action", "soustraitant");
    }

    public static void index() {
        List<models.Soustraitant> soustraitants = models.Soustraitant.findAll();
        render(soustraitants);
    }
