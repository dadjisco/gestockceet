...
public class User extends Controller {
    ...
    public static void profile() {
        String linkCancel = "portals.magasinier.User.profile";
        String linkProfile = "portals.magasinier.User.saveProfile";
        render(linkCancel, linkProfile);
    }

    public static void account() {
        String linkCancel = "portals.magasinier.User.account";
        String linkAccount = "portals.magasinier.User.saveAccount";
